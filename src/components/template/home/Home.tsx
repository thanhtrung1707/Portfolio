        ...
        <div className="flex justify-center relative">
            <div className="mb-10 mt-[100px]">
                ...
                <div className="flex justify-center">
                    <PresentContactSocial title="https://github.com/thanhtrung1707" color="bg-sky-300 observe-right"
                                          icon={<FaGithub color="black"/>}/>
                    <PresentContactSocial title="https://www.linkedin.com/in/trung-th%C3%A0nh-1a74b12a4/"
                                          color="bg-sky-300 observe-home-middle" icon={<FaLinkedin color="blue"/>}/>
                    <PresentContactSocial title="https://www.facebook.com/ttrung1707/" color="bg-sky-300 observe-home-left"
