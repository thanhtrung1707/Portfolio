                ...
                <div className='flex flex-col w-full h-full mt-5'>
                    ...
                    <div className='w-full grid sm:grid-cols-2 gap-10'>
                        <div className='sm:text-right text-3xl font-bold observe-me'>
                            <p>Hi. I'm Thanh Trung, nice to meet you Please take a look around .</p>
                        </div>
                        <div>
                            <p className={"text-xl text-gray-600 observe-me text-justify"}>
                                ...
                                and Reactjs,Nodejs. I am eager to become a fresher, In order to foster a lasting connection
